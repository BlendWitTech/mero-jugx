...
export default function InventorySidebar({
    ...
    const navItems = [
        { name: 'Dashboard', icon: LayoutDashboard, path: '' }, // path relative to app root
        { name: 'Products', icon: Package, path: '/products' },
        { name: 'Warehouses', icon: Warehouse, path: '/warehouses' },
        { name: 'Sales Orders', icon: ShoppingCart, path: '/sales-orders' },
        { name: 'Shipments', icon: Truck, path: '/shipments' },
        { name: 'Stock Movements', icon: ArrowLeftRight, path: '/movements' },
        { name: 'Adjustments', icon: History, path: '/adjustments' },
        { name: 'Settings', icon: Settings, path: '/settings' },
    ];

    console.log('[InventorySidebar] Rendering with navItems:', navItems);
    console.log('[InventorySidebar] AppSlug:', appSlug);
