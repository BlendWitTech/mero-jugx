...
import MeroInventorySidebar from '../components/MeroInventorySidebar';
import { isAppSubdomain } from '@frontend/config/urlConfig';
import { useQuery } from '@tanstack/react-query';
import api from '@frontend/services/api';

export default function MeroInventoryLayout() {
    ...
    const checkActive = (href: string, currentPath: string): boolean => {
        ...
        if (isSubdomainRoute) {
            ...
            appPath = currentPath.includes('/app/mero-inventory')
                ? currentPath.split('/app/mero-inventory')[1] || '/'
                : currentPath;
        }
