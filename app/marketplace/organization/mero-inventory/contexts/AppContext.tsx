...
export function AppProvider({
    ...
    const buildHref = (href: string): string => {
        if (isSubdomainRoute) {
            ...
            const currentPath = location.pathname;
            // Match /org/:slug/app/mero-inventory or /app/mero-inventory
            const appBaseMatch = currentPath.match(/\/org\/[^/]+\/app\/mero-inventory/) || currentPath.match(/\/app\/mero-inventory/);
