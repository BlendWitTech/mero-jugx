        ...
        const presetThemeGroups = [
          {
            key: 'default',
            themes: [
              { mode: 'dark' as const, colors: { primary: '#5865f2', secondary: '#4752c4', background: '#36393f', surface: '#2f3136', text: '#ffffff', textSecondary: '#b9bbbe', border: '#202225', accent: '#5865f2' } },
              { mode: 'light' as const, colors: { primary: '#5865f2', secondary: '#4752c4', background: '#ffffff', surface: '#f8f9fa', text: '#1a1c20', textSecondary: '#6b7280', border: '#e5e7eb', accent: '#5865f2' } },
            ]
          },
          {
            key: 'ocean-blue',
            themes: [
              { mode: 'dark' as const, colors: { primary: '#0ea5e9', secondary: '#0284c7', background: '#0f172a', surface: '#1e293b', text: '#f1f5f9', textSecondary: '#94a3b8', border: '#334155', accent: '#0ea5e9' } },
              { mode: 'light' as const, colors: { primary: '#0ea5e9', secondary: '#0284c7', background: '#f0f9ff', surface: '#e0f2fe', text: '#0c4a6e', textSecondary: '#075985', border: '#bae6fd', accent: '#0ea5e9' } },
            ]
          },
          {
            key: 'forest-green',
            themes: [
              { mode: 'dark' as const, colors: { primary: '#10b981', secondary: '#059669', background: '#064e3b', surface: '#065f46', text: '#d1fae5', textSecondary: '#6ee7b7', border: '#047857', accent: '#10b981' } },
              { mode: 'light' as const, colors: { primary: '#10b981', secondary: '#059669', background: '#ecfdf5', surface: '#d1fae5', text: '#065f46', textSecondary: '#047857', border: '#a7f3d0', accent: '#10b981' } },
            ]
          },
          {
            key: 'sunset-orange',
            themes: [
              { mode: 'dark' as const, colors: { primary: '#f97316', secondary: '#ea580c', background: '#431407', surface: '#7c2d12', text: '#fed7aa', textSecondary: '#fdba74', border: '#c2410c', accent: '#f97316' } },
              { mode: 'light' as const, colors: { primary: '#f97316', secondary: '#ea580c', background: '#fff7ed', surface: '#ffedd5', text: '#9a3412', textSecondary: '#c2410c', border: '#ffd4a3', accent: '#f97316' } },
            ]
          },
          {
            key: 'royal-purple',
            themes: [
              { mode: 'dark' as const, colors: { primary: '#a855f7', secondary: '#9333ea', background: '#3b0764', surface: '#581c87', text: '#e9d5ff', textSecondary: '#c084fc', border: '#9333ea', accent: '#a855f7' } },
              { mode: 'light' as const, colors: { primary: '#a855f7', secondary: '#9333ea', background: '#faf5ff', surface: '#f3e8ff', text: '#6b21a8', textSecondary: '#9333ea', border: '#d8b4fe', accent: '#a855f7' } },
            ]
          },
        ];
