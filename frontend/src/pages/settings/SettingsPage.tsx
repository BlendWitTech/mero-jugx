...
import { Shield, Bell, Lock, Users, Mail, Globe, Database, AlertTriangle, CheckCircle2, Info, Settings as SettingsIcon, Palette, Save } from 'lucide-react';
...
export default function SettingsPage() {
  ...
  const [activeTab, setActiveTab] = useState<'security' | 'notifications' | 'general' | 'theme'>('security');
