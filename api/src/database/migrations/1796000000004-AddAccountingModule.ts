...
export class AddAccountingModule1796000000004 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
          CREATE UNIQUE INDEX idx_account_org_code ON accounts(organization_id, code) WHERE organization_id IS NOT NULL
        `);

        await queryRunner.query(`
          CREATE UNIQUE INDEX idx_account_system_code ON accounts(code) WHERE organization_id IS NULL
        `);
