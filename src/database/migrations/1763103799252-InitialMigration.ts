...
export class InitialMigration1763103799252 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "packages" ("id" SERIAL NOT NULL, "name" character varying(100) NOT NULL, "slug" character varying(100) NOT NULL, "description" text, "base_user_limit" integer NOT NULL, "base_role_limit" integer NOT NULL, "additional_role_limit" integer NOT NULL DEFAULT '0', "price" numeric(10,2), "is_active" boolean NOT NULL DEFAULT true, "sort_order" integer NOT NULL DEFAULT '0', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_4b511952e9d60aac9aa42e653f0" UNIQUE ("name"), CONSTRAINT "UQ_4fa4c83eda7c58fa0861721db18" UNIQUE ("slug"), CONSTRAINT "PK_020801f620e21f943ead9311c98" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_174c1edc5687170b6ed98f576a" ON "packages" ("is_active") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_4fa4c83eda7c58fa0861721db1" ON "packages" ("slug") `);
        await queryRunner.query(`CREATE TABLE "permissions" ("id" SERIAL NOT NULL, "name" character varying(100) NOT NULL, "slug" character varying(100) NOT NULL, "description" text, "category" character varying(50) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_48ce552495d14eae9b187bb6716" UNIQUE ("name"), CONSTRAINT "UQ_d090ad82a0e97ce764c06c7b312" UNIQUE ("slug"), CONSTRAINT "PK_920331560282b8bd21bb02290df" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "role_permissions" ("id" SERIAL NOT NULL, "role_id" integer NOT NULL, "permission_id" integer NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_25d24010f53bb80b78e412c9656" UNIQUE ("role_id", "permission_id"), CONSTRAINT "PK_84059017c90bfcb701b8fa42297" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_917fb937fb332ed0c14846c9a6" ON "roles" ("is_system_role") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_fecdffec754fa4d5cea9870977" ON "invitations" ("user_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_35f274748195ecebcc7c138b9c" ON "invitations" ("expires_at") `);
        await queryRunner.query(`CREATE INDEX "IDX_56ce8d405de7cdcedd31d900ba" ON "invitations" ("status") `);
        await queryRunner.query(`CREATE INDEX "IDX_3afc80b5ecc0276428da3e3a87" ON "invitations" ("organization_id", "email") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_e577dcf9bb6d084373ed399850" ON "invitations" ("token") `);
        await queryRunner.query(`CREATE TYPE "public"."package_features_type_enum" AS ENUM('user_upgrade', 'role_upgrade')`);
        await queryRunner.query(`CREATE TABLE "package_features" ("id" SERIAL NOT NULL, "name" character varying(100) NOT NULL, "slug" character varying(100) NOT NULL, "type" "public"."package_features_type_enum" NOT NULL, "value" integer, "price" numeric(10,2) NOT NULL, "description" text, "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_414a566d05aa19276fd12c94e95" UNIQUE ("name"), CONSTRAINT "UQ_472218c0cc935b5b820d0bca3b3" UNIQUE ("slug"), CONSTRAINT "PK_62d8d878bc152b6b42224c7ff15" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_fa94e031b5dbb95b495e8f9580" ON "package_features" ("type") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_472218c0cc935b5b820d0bca3b" ON "package_features" ("slug") `);
        await queryRunner.query(`CREATE TYPE "public"."organization_package_features_status_enum" AS ENUM('active', 'cancelled')`);
        await queryRunner.query(`CREATE TABLE "organization_package_features" ("id" SERIAL NOT NULL, "organization_id" uuid NOT NULL, "feature_id" integer NOT NULL, "status" "public"."organization_package_features_status_enum" NOT NULL DEFAULT 'active', "purchased_at" TIMESTAMP NOT NULL DEFAULT now(), "cancelled_at" TIMESTAMP, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_81b61c5a843e4f4eb8d6679ff5d" UNIQUE ("organization_id", "feature_id"), CONSTRAINT "PK_14d74e9066e373e182e8e492bfa" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_572c29601a80c4b8df243af042" ON "organization_package_features" ("organization_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_28facf3cb1f34e92ef00e83179" ON "organization_package_features" ("feature_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_76c0407957e441a0f13b26926f" ON "organization_package_features" ("status") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_68d007d564953c00ae74c13dc2" ON "organizations" ("package_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_f3770f157bd77d83ab022e92fc" ON "organizations" ("status") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_4ad920935f4d4eb73fc58b40f7" ON "organizations" ("email") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_963693341bd612aa01ddf3a4b6" ON "organizations" ("slug") `);
        await queryRunner.query(`CREATE TYPE "public"."organization_members_status_enum" AS ENUM('active', 'revoked', 'left')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_5af5b0cc7f3012e9eb45d3df35" ON "organization_members" ("role_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_e6ebf5aab7a65fdb7de52051f6" ON "organization_members" ("status") `);
        await queryRunner.query(`CREATE TABLE "sessions" ("id" character varying(255) NOT NULL, "user_id" uuid NOT NULL, "organization_id" uuid NOT NULL, "access_token" text, "refresh_token" character varying(255), "ip_address" character varying(45), "user_agent" text, "expires_at" TIMESTAMP NOT NULL, "revoked_at" TIMESTAMP, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_c862499023be8feec98129d4e96" UNIQUE ("refresh_token"), CONSTRAINT "PK_3238ef96f18b355b671619111bc" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_085d540d9f418cfbdc7bd55bb1" ON "sessions" ("user_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_a9e3486bb3e8509466d4c9d6c9" ON "sessions" ("organization_id") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_8d19d2ba2fddbaca8c227048d5" ON "notifications" ("read_at") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_cf96ca0dc9c97fdc2ae06831d8" ON "users" ("email_verified") `);
        ...
        await queryRunner.query(`ALTER TABLE "organization_package_features" ADD CONSTRAINT "FK_572c29601a80c4b8df243af0424" FOREIGN KEY ("organization_id") REFERENCES "organizations"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "organization_package_features" ADD CONSTRAINT "FK_28facf3cb1f34e92ef00e83179c" FOREIGN KEY ("feature_id") REFERENCES "package_features"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "organizations" ADD CONSTRAINT "FK_68d007d564953c00ae74c13dc2b" FOREIGN KEY ("package_id") REFERENCES "packages"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "organization_members" ADD CONSTRAINT "FK_78252b40612aaddc2138eadc810" FOREIGN KEY ("invited_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "organization_members" ADD CONSTRAINT "FK_45bfedcbbe8c4031ce3bb50843d" FOREIGN KEY ("revoked_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "organization_members" ADD CONSTRAINT "FK_e98ba40eae3f5b5f9d1dd80da01" FOREIGN KEY ("data_transferred_to") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "sessions" ADD CONSTRAINT "FK_a9e3486bb3e8509466d4c9d6c93" FOREIGN KEY ("organization_id") REFERENCES "organizations"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "sessions" DROP CONSTRAINT "FK_a9e3486bb3e8509466d4c9d6c93"`);
        await queryRunner.query(`ALTER TABLE "sessions" DROP CONSTRAINT "FK_085d540d9f418cfbdc7bd55bb19"`);
        await queryRunner.query(`ALTER TABLE "organization_members" DROP CONSTRAINT "FK_e98ba40eae3f5b5f9d1dd80da01"`);
        await queryRunner.query(`ALTER TABLE "organization_members" DROP CONSTRAINT "FK_45bfedcbbe8c4031ce3bb50843d"`);
        await queryRunner.query(`ALTER TABLE "organization_members" DROP CONSTRAINT "FK_78252b40612aaddc2138eadc810"`);
        ...
        await queryRunner.query(`ALTER TABLE "organizations" DROP CONSTRAINT "FK_68d007d564953c00ae74c13dc2b"`);
        await queryRunner.query(`ALTER TABLE "organization_package_features" DROP CONSTRAINT "FK_28facf3cb1f34e92ef00e83179c"`);
        await queryRunner.query(`ALTER TABLE "organization_package_features" DROP CONSTRAINT "FK_572c29601a80c4b8df243af0424"`);
