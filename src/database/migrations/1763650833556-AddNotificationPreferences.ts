...
export class AddNotificationPreferences1763650833556 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."notification_preferences_scope_enum" AS ENUM('personal', 'organization')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_7e6d48f418bce30f6bed5e9e6f" ON "notification_preferences" ("organization_id")`);
        await queryRunner.query(`CREATE INDEX "IDX_185e6e397d3f589e0036f2fa61" ON "notification_preferences" ("scope")`);
        ...
        await queryRunner.query(`ALTER TABLE "notification_preferences" ADD CONSTRAINT "FK_7e6d48f418bce30f6bed5e9e6f3" FOREIGN KEY ("organization_id") REFERENCES "organizations"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        // Drop foreign key constraints
        await queryRunner.query(`ALTER TABLE "notification_preferences" DROP CONSTRAINT "FK_7e6d48f418bce30f6bed5e9e6f3"`);
